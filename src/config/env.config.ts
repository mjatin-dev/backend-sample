...
const env: Environment = cleanEnv(fullEnv, {
  ...
  SQS_ANOMALY_RULE_APPLIER_QUEUE_URL: str({
    desc: 'SQS data set url for triggering the Anomaly rule applier process',
    devDefault:
      'https://sqs.us-east-1.amazonaws.com/513036925867/dev-aws-useast1-anomaly-analysis-queue.fifo',
  }),
  ...
  SQS_DATA_MIGRATION_REMOVAL_QUEUE_URL: str({
    desc: 'SQS data set url for triggering the data migration removal process',
    devDefault:
      'https://sqs.us-east-1.amazonaws.com/513036925867/dev-aws-useast1-data-migration-removal-queue.fifo',
  }),
