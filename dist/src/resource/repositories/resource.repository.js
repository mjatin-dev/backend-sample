...
let ResourceRepository = class ResourceRepository extends typeorm_transactional_cls_hooked_1.BaseRepository {
...
ResourceRepository = __decorate([
    (0, typeorm_1.EntityRepository)(resource_entity_1.Resource)
], ResourceRepository);
