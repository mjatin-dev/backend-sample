...
let TenantRepository = class TenantRepository extends typeorm_transactional_cls_hooked_1.BaseRepository {
};
TenantRepository = __decorate([
    (0, typeorm_1.EntityRepository)(tenant_entity_1.Tenant)
], TenantRepository);
